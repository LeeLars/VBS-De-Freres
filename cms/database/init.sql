...
('klassen', '1a-teacher-name', 'juf Lies / meester Simon', 'text'),
('klassen', '1a-text', 'Het eerste leerjaar! Een spannend jaar vol nieuwe ontdekkingen. Leren lezen, schrijven en rekenen.', 'text'),
('klassen', '1a-photo', '', 'image'),
('klassen', '1a-teacher-photo', '', 'image'),
('klassen', '2a-teacher-name', 'juf Stefanie', 'text'),
('klassen', '2a-text', 'In het tweede leerjaar bouwen we verder op de basis. Lezen wordt vlotter, rekenen uitdagender.', 'text'),
('klassen', '2a-photo', '', 'image'),
('klassen', '2a-teacher-photo', '', 'image'),
('klassen', '3a-teacher-name', 'juf Melissa', 'text'),
('klassen', '3a-text', 'Het derde leerjaar brengt nieuwe uitdagingen. Meer zelfstandig werken, complexere opdrachten en nieuwe vakken.', 'text'),
('klassen', '3a-photo', '', 'image'),
('klassen', '3a-teacher-photo', '', 'image'),
('klassen', '3b-teacher-name', 'juf Aurelie', 'text'),
('klassen', '3b-text', 'In klas 3B leren de kinderen steeds meer zelfstandig te werken. Projecten, groepswerk en nieuwe leerstof.', 'text'),
('klassen', '3b-photo', '', 'image'),
('klassen', '3b-teacher-photo', '', 'image'),
('klassen', '4a-teacher-name', 'juf Emma', 'text'),
('klassen', '4a-text', 'Het vierde leerjaar is een belangrijk jaar. De kinderen worden voorbereid op de bovenbouw.', 'text'),
('klassen', '4a-photo', '', 'image'),
('klassen', '4a-teacher-photo', '', 'image'),
('klassen', '4b-teacher-name', 'juf Tine', 'text'),
('klassen', '4b-text', 'In klas 4B werken we aan zelfstandigheid en kritisch denken.', 'text'),
('klassen', '4b-photo', '', 'image'),
('klassen', '4b-teacher-photo', '', 'image'),
('klassen', '5a-teacher-name', 'juf Anneke', 'text'),
('klassen', '5a-text', 'Het vijfde leerjaar! Meer verantwoordelijkheid, uitdagende projecten en voorbereiding op het secundair.', 'text'),
('klassen', '5a-photo', '', 'image'),
('klassen', '5a-teacher-photo', '', 'image'),
('klassen', '6a-teacher-name', 'juf Kelly', 'text'),
('klassen', '6a-text', 'Het laatste jaar van de lagere school! Een bijzonder jaar vol mooie momenten en voorbereiding op het secundair onderwijs.', 'text'),
('klassen', '6a-photo', '', 'image'),
('klassen', '6a-teacher-photo', '', 'image'),
('klassen', 'talen-text', 'In onze talenklas krijgen kinderen extra ondersteuning in meertaligheid. We werken aan taaluitbreiding en taalverrijking.', 'text'),
('klassen', 'talen-photo', '', 'image'),
('klassen', 'talen-teacher-photo', '', 'image'),
('klassen', 'talen-teacher-name', 'Talenklas team', 'text'),
('klassen', 'sport-text', 'Beweging is belangrijk! In onze sportlessen leren kinderen sportieve vaardigheden, samenwerken en plezier hebben in bewegen.', 'text'),
('klassen', 'sport-photo', '', 'image'),
('klassen', 'sport-teacher-photo', '', 'image'),
('klassen', 'sport-teacher-name', 'Sportteam', 'text')
ON CONFLICT (page_slug, content_key) DO NOTHING;
